...
export interface EnvironmentVariables {
  ...
  NOMBA_WEBHOOK_SIGNATURE_KEY: string;
...
export function validateEnvironment(
  ...
  const nombaWebhookSignatureKey = readString(
    config,
  ...
  return {
    ...
    NOMBA_WEBHOOK_SIGNATURE_KEY: nombaWebhookSignatureKey,
